...
import { MerchantCommandController } from "./modules/merchant/controllers/merchantcommand.controller";
import { MerchantModule } from "./modules/merchant/modules/merchant.module";
import { CqrsModule } from "@nestjs/cqrs";
import { AppDataSource, initializeDatabase } from "./data-source";
import { MerchantQueryController } from "./modules/merchant/controllers/merchantquery.controller";
import { GraphQLModule } from "@nestjs/graphql";
import { ApolloDriver, ApolloDriverConfig } from "@nestjs/apollo";
import GraphQLJSON from "graphql-type-json";
import { MerchantCommandService } from "./modules/merchant/services/merchantcommand.service";
import { MerchantQueryService } from "./modules/merchant/services/merchantquery.service";
import { CacheModule } from "@nestjs/cache-manager";
import { LoggingModule } from "./modules/merchant/modules/logger.module";
...
@Module({
  ...
  /**
   * Controladores de Merchant
   *
   * Registro de controladores a nivel de aplicación.
   */
  controllers: [
  //No se recomienda habilitar los controladores si ya fueron declarados en el módulo: MerchantModule
  /*
  
  MerchantCommandController, 
  MerchantQueryController
  
  */
  ],

  /**
   * Proveedores (Servicios, Repositorios, etc.) de Merchant
   *
   ...
   */
  exports: [MerchantCommandService, MerchantQueryService,LoggerService],
})
export class MerchantAppModule implements OnModuleInit {
  /**
