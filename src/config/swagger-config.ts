...
export function setupSwagger(
  ...
  title: string = "Merchant Service API",
  description: string = "API completa para gestión de Merchants con documentación automática",
  version: string = "1.0"
): string {
try{
  const localPort = String(process.env.PORT || "3000");
      const swaggerConfig = new DocumentBuilder()
        ...
        //.addTag("Merchants", "Gestión de transacciones y procesamiento de merchants")
      ...
      const swaggerDocument = SwaggerModule.createDocument(app, swaggerConfig, {
        include: [MerchantModule,         MerchantGatewayConfigModule,/*, AuthModule, ReportsModule*/], // Lista todos los módulos
