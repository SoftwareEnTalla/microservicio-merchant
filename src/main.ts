...
import { MerchantAppModule } from "./app.module";
...
async function bootstrap() {
  ...
  try {
    ...
    logger.info(`ℹCreando instancia del módulo MerchantAppModule...`);
    const app = await NestFactory.create(MerchantAppModule, {
    ...
    const swaggerPath = setupSwagger(
      ...
      "API completa para gestión de Merchants con documentación automática",
      "1.0"
    );
