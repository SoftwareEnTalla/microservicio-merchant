...
import { DeleteMerchantCommand } from "../deletemerchant.command";
import { MerchantCommandService } from "../../services/merchantcommand.service";

@CommandHandler(DeleteMerchantCommand)
export class DeleteMerchantHandler
  implements ICommandHandler<DeleteMerchantCommand>
{
  constructor(
    private readonly commandService: MerchantCommandService
  ) {}
