...
@Module({
  controllers: [MerchantApprovalStatusCommandController],
  providers: [
  ...
  exports: [MerchantApprovalStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthMerchantApprovalStatusModule {}
