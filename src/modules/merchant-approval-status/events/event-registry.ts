...
import { MerchantApprovalStatusCreatedEvent } from './merchantapprovalstatuscreated.event';
import { MerchantApprovalStatusUpdatedEvent } from './merchantapprovalstatusupdated.event';
import { MerchantApprovalStatusDeletedEvent } from './merchantapprovalstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'merchant-approval-status-created': createEventDefinition('merchant-approval-status-created', MerchantApprovalStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['merchant-approval-status-created']),
  'merchant-approval-status-updated': createEventDefinition('merchant-approval-status-updated', MerchantApprovalStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['merchant-approval-status-updated']),
  'merchant-approval-status-deleted': createEventDefinition('merchant-approval-status-deleted', MerchantApprovalStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['merchant-approval-status-deleted']),
