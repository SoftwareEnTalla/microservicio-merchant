...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class MerchantGatewayConfigStatusRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[MerchantGatewayConfigStatus[], number]> {
      logger.info('Ready to findByField MerchantGatewayConfigStatus on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of MerchantGatewayConfigStatus with id:  was finded on repository:', instance);
