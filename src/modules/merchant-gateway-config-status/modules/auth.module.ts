...
@Module({
  controllers: [MerchantGatewayConfigStatusCommandController],
  providers: [
  ...
  exports: [MerchantGatewayConfigStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthMerchantGatewayConfigStatusModule {}
