...
import { MerchantGatewayConfigStatusCreatedEvent } from './merchantgatewayconfigstatuscreated.event';
import { MerchantGatewayConfigStatusUpdatedEvent } from './merchantgatewayconfigstatusupdated.event';
import { MerchantGatewayConfigStatusDeletedEvent } from './merchantgatewayconfigstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'merchant-gateway-config-status-created': createEventDefinition('merchant-gateway-config-status-created', MerchantGatewayConfigStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['merchant-gateway-config-status-created']),
  'merchant-gateway-config-status-updated': createEventDefinition('merchant-gateway-config-status-updated', MerchantGatewayConfigStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['merchant-gateway-config-status-updated']),
  'merchant-gateway-config-status-deleted': createEventDefinition('merchant-gateway-config-status-deleted', MerchantGatewayConfigStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['merchant-gateway-config-status-deleted']),
