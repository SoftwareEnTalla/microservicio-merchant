...
@Module({
  controllers: [MerchantGatewayConfigCommandController],
  providers: [
  ...
  exports: [MerchantGatewayConfigAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthMerchantGatewayConfigModule {}
