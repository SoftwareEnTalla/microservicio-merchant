...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class MerchantGatewayConfigRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[MerchantGatewayConfig[], number]> {
      logger.info('Ready to findByField MerchantGatewayConfig on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of MerchantGatewayConfig with id:  was finded on repository:', instance);
