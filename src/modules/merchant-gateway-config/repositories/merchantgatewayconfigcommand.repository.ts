...
export class MerchantGatewayConfigCommandRepository implements IEventHandler<BaseEvent>{
  ...
  async create(entity: MerchantGatewayConfig): Promise<MerchantGatewayConfig> {
    ...
    if (this.shouldPublishEvent()) {
      const __dualEvt1 = new MerchantGatewayConfigCreatedEvent(result.id, {
        instance: result,
        metadata: {
  ...
  async bulkCreate(entities: MerchantGatewayConfig[]): Promise<MerchantGatewayConfig[]> {
    ...
    if (this.shouldPublishEvent()) {
      const __dualEvts2 = result.map((el)=>new MerchantGatewayConfigCreatedEvent(el.id, {
        instance: el,
        metadata: {
  ...
  async update(
    ...
    if(instance && this.shouldPublishEvent()) {
      ...
      const __dualEvt3 = new MerchantGatewayConfigUpdatedEvent(instance.id, {
          instance: instance,
          metadata: {
    ...
    for (const entity of entities) {
      if (entity.id) {
        ...
        if (updatedEntity) {
          ...
          if (this.shouldPublishEvent()) {
            const __dualEvt4 = new MerchantGatewayConfigUpdatedEvent(updatedEntity.id, {
  ...
  async delete(id: string): Promise<DeleteResult> {
     ...
     if (this.shouldPublishEvent()) {
       ...
       const __dualEvt5 = new MerchantGatewayConfigDeletedEvent(id, {
        instance: entity,
        metadata: {
