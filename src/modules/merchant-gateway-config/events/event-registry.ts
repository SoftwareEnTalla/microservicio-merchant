...
import { MerchantGatewayConfigCreatedEvent } from './merchantgatewayconfigcreated.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'merchant-gateway-config-created': createEventDefinition('merchant-gateway-config-created', MerchantGatewayConfigCreatedEvent, EVENT_DEFINITION_OVERRIDES['merchant-gateway-config-created']),
